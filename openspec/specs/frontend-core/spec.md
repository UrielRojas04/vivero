...
El acento cromático de la interfaz MUST corresponder a la unidad de negocio activa, resuelto vía el atributo `data-unidad` del documento y no mediante props de tema ni condicionales por componente.
