...
- **WHEN** un usuario autenticado hace click en "Productos" o "Insumos" del sidebar
- **THEN** el sistema navega a `/productos` o `/insumos` respectivamente, sin recargar la página y resalta visualmente la opción activa en el sidebar
