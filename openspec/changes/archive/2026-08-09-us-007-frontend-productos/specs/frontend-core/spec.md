...
- **WHEN** un usuario autenticado hace click en "Productos" del sidebar
- **THEN** el sistema navega a `/productos` sin recargar la página y resalta visualmente la opción activa en el sidebar
